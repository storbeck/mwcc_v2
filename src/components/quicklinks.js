    ...
    <div className={classes.root}>
      <div className={classes.child}>
        ...
        <div style={{display: 'flex', flexDirection: 'column'}}>
            { links.map((link, idx) => <Link key={idx} href={link.route} style={{color: 'white', fontWeight: 500, height: 35}}>{link.name}</Link>) }
        </div>
      </div>
      <div className={classes.child}>
        <Typography className={classes.title} variant="h6" component="h6">Contact Info</Typography>
        <Typography variant="body1" component="p" style={{marginTop: 10}}>Phone: <strong>(614) 532-3026 | 614-208-0549</strong></Typography>
        <Typography variant="body1" component="p" style={{marginTop: 10}}>Email: <strong>office@mayswilson.com</strong></Typography>
        <Typography variant="body1" component="p" style={{marginTop: 10}}>Address: <strong>743 Columbus St., Etna, OH 43018</strong></Typography>
        <Typography variant="body1" component="p" style={{marginTop: 10}}>Business Hours:</Typography>
        <Typography variant="body1" component="p" style={{marginTop: 10}}>Mon - Fri: 8:00 am - 6:00 pm </Typography>
        <Typography variant="body1" component="p" style={{marginTop: 10}}>We are open 24/7 for those in need of emergency repairs services.</Typography>
        ...
        <Typography variant="body1" component="p" style={{marginTop: 10}}>LICENSE NUMBERS: G05915; HIC02545;</Typography>
